		...
		<title>eDey Subscription</title>
			...
			<body style="margin:0px; font-family:Tahoma, Geneva, sans-serif;">
				<div style="padding:10px; background:#333; font-size:19px; color:#CCC;">
					...
					eDey Service Termination
				</div>
				<div style="padding:24px; font-size:13px;">
					<span style="font-weight:bold">{{$name}}</span>, your business Listing has expired, and will not be listed when people search for 
						your business type. Please reactivate it by subscribing again.
